            ...
            <div className="container" style={{ marginBottom: '29px', marginTop: '-15px' }}>
...

                {
                    preview ? <div className="container50" style={{ width: '70%', margin: 'auto' }}>
                        ...
                        <textarea value={title} onChange={e => setTitle(e.target.value)} style={{ backgroundColor: !context.dark ? 'rgb(248, 248, 248)' : '#202020', color: 'inherit', padding: '15px', border: 'none', borderRadius: '5px', outline: 'none', resize: 'none', width: '100%', height: '78px', fontSize: '17px', marginBottom: '-1.2px' }} placeholder='Title of the blog *'></textarea>
                        <textarea value={tags} onChange={e => { setTags(e.target.value); }} className='boxins' style={{ backgroundColor: !context.dark ? 'rgb(248, 248, 248)' : '#202020', color: 'inherit', padding: '15px', border: 'none', borderRadius: '5px', outline: 'none', resize: 'none', width: '100%', height: '55px', fontSize: '15.5px', marginBottom: '-1.2px' }} placeholder='Enter tags (eg : javscript,typescript)'></textarea>
                        <textarea value={summary} onChange={e => setSummary(e.target.value)} className='boxins' style={{ backgroundColor: !context.dark ? 'rgb(248, 248, 248)' : '#202020', color: 'inherit', padding: '15px', border: 'none', borderRadius: '5px', outline: 'none', resize: 'none', width: '100%', height: '135px', fontSize: '15.5px', marginBottom: '-1.2px' }} placeholder='Summary of the post *'></textarea>
                        <textarea style={{ width: '100%', backgroundColor: !context.dark ? 'rgb(248, 248, 248)' : '#202020', color: 'inherit', padding: '15px', border: 'none', borderRadius: '5px', outline: 'none', minHeight: '84vh', resize: 'none', fontSize: '15.5px' }} value={value} onChange={e => setValue(e.target.value)} spellCheck="false"></textarea>
                    </div>
                }
