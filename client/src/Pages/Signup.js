  ...
  return (
    <div className="containerlogin">
      ...
      <div className="leftlogin">
        <img style={{ marginTop: '45px', minWidth: '400px', width: '74%' }} src={loginimg} alt="" />
      </div>
      <div className="rightlogin">
        ...
        <input type="text" placeholder='Enter Name' style={{ background: context.dark ? 'rgb(66 66 66)' : 'white', height: '47px', outline: 'none', border: 'none', borderRadius: '5px', color: 'inherit', width: '325px', marginTop: '20px', paddingLeft: '14px' }} value={username} onChange={(e) => setusername(e.target.value)} />
